...
def test_discover_target_keys_skips_controls():
    samples = [
        {
            "collection_date": "2026-06-11",
            "targets": {
                "PMMoV": {"gc_g_dry_weight": 1000, "activity_category": "normal"},
                "Rota": {"gc_g_dry_weight": 1000, "activity_category": "high"},
            },
        }
    ]
    assert discover_target_keys(samples) == ["Rota"]
