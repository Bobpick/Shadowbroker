...
| **Ollama + `cogito:32b`** | Local LLM for executive prose |
...
- **Ollama** + disk for `cogito:32b` (~19 GB)
...
export DAILY_BRIEF_OLLAMA_MODEL=cogito:32b
...
3. `ollama pull cogito:32b` and Ollama running  
